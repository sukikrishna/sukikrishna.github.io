...
function map() {
  ...
  if ($("#" + mapId).length > 0) {
    ...
    if (mapMarker) {
      ...
      marker.bindPopup(
        "<div class='p-3'><h3 class='font-weight-bold text-uppercase'>Info Window Content</h3><p class='text-muted'>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p></div>",
        {
          minwidth: 200,
          maxWidth: 600,
